...
class Product extends CI_Controller {
    ...
    public function addproducts(){
        ...
        $finalsubcat = array_merge($post_subcat,$post_egger);
        ...
        'subcat_id'=>$subcat,'lowcat_id'=>$lowcat,'property_id'=>$egger,'variant_id'=>$variant_id,
        'variant_price'=>$variant_price,'path'=>$t,'variant_stock_qty'=>$variant_stock_qty);
