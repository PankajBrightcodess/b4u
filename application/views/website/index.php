    ...
    <section class="banner">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-pause="false">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active"><a href="#"><img src="<?php echo file_url('assets/website/images/slider/banner01.jpg'); ?>" class="d-block w-100" alt="Slide1"></a></div>
          <div class="carousel-item"><a href="#"><img src="<?php echo file_url('assets/website/images/slider/banner02.jpg'); ?>" class="d-block w-100" alt="Slide2"></a></div>
          <div class="carousel-item"><a href="#"><img src="<?php echo file_url('assets/website/images/slider/banner03.jpg'); ?>" class="d-block w-100" alt="Slide3"></a></div>
        </div>
      ...
      <?php if(!empty($categorytree)){ $j=0;
        ...
        <div class="row" style="margin-top: 50px; margin-bottom:30px;">
          <div class="col-lg-12 col-md-12 col-12">
            <img src="<?= base_url('assets/website/images/add/01.jpg')?>">
          </div>
        </div>
        ...
        if($j==2){
            ...
            <div class="row" style="margin-top: 50px; margin-bottom:30px;">
              <div class="col-lg-12 col-md-12 col-12">
                <img src="<?= base_url('assets/website/images/add/03.jpg')?>">
              </div>
            </div>
        ...
        if ($j==4) {
          ?>
            <div class="row" style="margin-top: 50px; margin-bottom:30px;">
              <div class="col-lg-12 col-md-12 col-12">
                <img src="<?= base_url('assets/website/images/add/04.jpg')?>">
              </div>
            </div>
        ...
        if ($j==6) {
          ?>
            <div class="row" style="margin-top: 50px; margin-bottom:30px;">
              <div class="col-lg-12 col-md-12 col-12">
                <img src="<?= base_url('assets/website/images/add/02.jpg')?>">
              </div>
            </div>
        ...
        <!-- <div class="row">
          <div class="col-lg-12 col-md-12 col-12">
            <img src="<?= base_url('assets/website/images/add/05.jpg')?>">
          </div>
        </div> -->       
      </div>
    </div>
