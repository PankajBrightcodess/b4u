...
<section class="CategoryBox">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <button type="button" name="CategoryListIcon" class="btn btn-success" data-toggle="collapse" data-target="#CategoriesPanel" aria-expanded="false" aria-controls="CategoriesPanel"><img src="<?php echo file_url('assets/website/images/category.svg'); ?>" alt="Category List"> <span>Shop by Category</span></button>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
